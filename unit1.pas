...
begin
 ...
 {b2}m1[21] := 25; m1[22] := 42; m1[23] := 140; m1[24] := 32;
  ...
  m1[63] := 59; m1[64] := 104;{la4}m1[65] := 24; m1[66] := 574;
  ...
  Memo1.Font.Size := Round(pic * 8); Memo3.Font.Size := Round(pic * 8);
  Button1.Font.Size := Round(pic * 10); Button2.Font.Size := Round(pic * 10);
  Button3.Font.Size := Round(pic * 10); Button4.Font.Size := Round(pic * 10);
  Button5.Font.Size := Round(pic * 10); Button6.Font.Size := Round(pic * 10);
  Label5.Font.Size := Round(pic * 10); Label2.Font.Size := Round(pic * 6);
  Label3.Font.Size := Round(pic * 6); MaskEdit1.Font.Size := Round(pic * 8);
  Label4.Font.Size := Round(pic * 10);MaskEdit2.Font.Size := Round(pic * 8);
  Label6.Font.Size := Round(pic * 6);
  end;
end;
...
{   Numarrayx[i] := StrtoFloat(GetToken(tempStr, ' ', 7));
   ...
   else Label5.Caption := 'Path choice error line 1945';
   end;
